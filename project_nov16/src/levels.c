...
//this file contains all the code for the functions that deal with levels or displaying instruction in the game 
#include<curses.h>
#include<stdio.h>
#include<unistd.h>
#include"levels.h"
...
//when the int of the level is called the level will be opened 
